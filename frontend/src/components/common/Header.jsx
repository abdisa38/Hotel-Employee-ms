...
import { Calendar, Fingerprint, UserPlus } from 'lucide-react';

export default function Header({ activeTab, onQuickPunchClick, onAddEmployeeClick }) {
  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200 px-6 flex items-center justify-between sticky top-0 z-20">
      ...
      {/* Action Buttons: Visible only on Dashboard */}
      {activeTab === 'dashboard' && (
